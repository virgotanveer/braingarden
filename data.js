...
const FLASHCARD_DECKS = {
  ...
  worldCapitals: {
    ...
    ageHint: "7-10",
    cards: [
      { q: "🇺🇸", label: "United States", a: "Washington, D.C.", fact: "Washington, D.C. is not part of any US state." },
      { q: "🇬🇧", label: "United Kingdom", a: "London", fact: "London sits on the River Thames." },
      { q: "🇫🇷", label: "France", a: "Paris", fact: "Paris is nicknamed 'The City of Light'." },
      { q: "🇮🇳", label: "India", a: "New Delhi", fact: "New Delhi is part of India's capital territory." },
      { q: "🇯🇵", label: "Japan", a: "Tokyo", fact: "Tokyo is one of the most populated cities on Earth." },
      { q: "🇨🇦", label: "Canada", a: "Ottawa", fact: "Ottawa is Canada's capital, not Toronto!" },
      { q: "🇦🇺", label: "Australia", a: "Canberra", fact: "Canberra was specially built to be Australia's capital." },
      { q: "🇪🇬", label: "Egypt", a: "Cairo", fact: "Cairo sits along the Nile, the longest river in the world." },
      { q: "🇮🇹", label: "Italy", a: "Rome", fact: "Rome is home to the ancient Colosseum." },
      { q: "🇩🇪", label: "Germany", a: "Berlin", fact: "Berlin was once divided by a famous wall." }
    ]
  },
  scienceAdvanced: {
...
const BADGES = [
  ...
  { id: "math_whiz",      icon: "🧮", name: "Math Whiz",     desc: "Reach Math Quiz level 5",         check: s => ((s.levels.math && s.levels.math.unlocked) || 1) >= 5 },
  { id: "word_wizard",    icon: "🔤", name: "Word Wizard",   desc: "Reach Word Scramble level 3",     check: s => ((s.levels.scramble && s.levels.scramble.unlocked) || 1) >= 3 },
  { id: "clock_master",   icon: "🕐", name: "Clock Master",  desc: "Reach Telling Time level 5",      check: s => ((s.levels.time && s.levels.time.unlocked) || 1) >= 5 },
